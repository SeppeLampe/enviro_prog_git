...
The default installation preferences are mostly fine, **except** that you should deviate and follow this print screen for handling line endings![this step](https://github.com/lwilgrant/enviro_prog_git/blob/main/install_option.png)
